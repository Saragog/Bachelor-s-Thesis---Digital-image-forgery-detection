...
src/%.o: ../src/%.cpp
	...
	g++ -I/usr/include/qt4 -I/home/andrzej/Pobrane/exiv2-0.25/include/exiv2 -I/usr/include/qt4/QtCore -I/usr/include/qt4/QtGui -O0 -g3 -Wall -c -fmessage-length=0 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
